...
export const SAVE_ASSETS_ALLOCATION_FAIL = 'saveAssetsAllocationFail';
...
export const GET_ASSET_CATEGORIES_FROM_BETA_GROUPS_SUCCESS =
  'getAssetCategoriesFromBetaGroupsSuccess';
export const GET_ASSET_CATEGORIES_FROM_BETA_GROUPS_FAIL =
  'getAssetCategoriesFromBetaGroupsFail';
export const GET_ASSET_CATEGORIES_FROM_GOAL_ORIENTED_SUCCESS =
  'getAssetCategoriesFromGoalOrientedSuccess';
export const GET_ASSET_CATEGORIES_FROM_GOAL_ORIENTED_FAIL =
  'getAssetCategoriesFromGoalOrientedFail';
export const GET_ASSET_CATEGORIES_FROM_LDI_SUCCESS =
  'getAssetCategoriesFromLDISuccess';
export const GET_ASSET_CATEGORIES_FROM_LDI_FAIL =
